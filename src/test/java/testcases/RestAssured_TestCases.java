 ...
 * 5. Assert that the response status code is 200 (OK) and the status line matches "HTTP/1.1 200 OK".
 ...
 * 4. Assert that the response status code is 200 (OK) and the status line matches "HTTP/1.1 200 OK".
 ...
 */
	...
	@Test(priority = 6, description = "1. Send a GET request to the endpoint '/web/index.php/api/v2/leave/leave-types/eligible' with a valid cookie"
			+ "2. Do not pass any request body (null)\n"
			+ "3. Print and verify the response status code and response body\n"
			+ "4. Assert that the response status code is 200 (OK)")
 ...
 * 4. Assert that the HTTP status code is 200 and the status line is "HTTP/1.1 200 OK".
 ...
 */
	...
	@Test(priority = 7, description = "1. Send a GET request to the endpoint '/web/index.php/api/v2/leave/leave-requests?limit=50&offset=0&includeEmployees=onlyCurrent' with a valid cookie"
        + "2. Do not pass any request body (null)\n"
        + "3. Print and verify the response status code and response body\n"
        + "4. Assert that the response status code is 200 (OK)")
 ...
 */
	...
	@Test(priority = 8, description = "1. Send a GET request to the endpoint '/web/index.php/api/v2/leave/leave-periods' with a valid cookie"
			+ "2. Do not pass any request body (null)\n"
			+ "3. Print and verify the response status code and response body\n"
			+ "4. Assert that the response status code is 200 (OK)")
 ...
 * 4. Assert that the response status code is 200 and status line is "HTTP/1.1 200 OK".
 ...
 */
	...
	@Test(priority = 9, description = "1. Send a GET request to the endpoint '/web/index.php/api/v2/leave/workweek?model=indexed' with a valid cookie"
			+ "2. Do not pass any request body (null)\n"
			+ "3. Print and verify the response status code and response body\n"
			+ "4. Assert that the response status code is 200 (OK)")
 ...
 * 5. Assert that the response status code is 200 and status line is "HTTP/1.1 200 OK".
 ...
 */
	...
	@Test(priority = 10, description = "1. Send a GET request to the endpoint '/web/index.php/api/v2/leave/workweek' with a valid cookie"
    ...
    CustomResponse customResponse = apiUtil.GetWorkWeekdays(endpoint, cookieValue, headerKey, headerValue);
		...
		Assert.assertEquals(customResponse.getWorkWeekData().get("0"), 8, "Sunday should be 8 hours.");
 ...
 */
	...
	@Test(priority = 11, description = "1. Construct the url using the endpoint '/web/index.php/api/v2/pim/custom-fields\n'"
 ...
 */
	...
	@Test(priority=12, description = "1. Create a body for adding reporting method as {name: \"abcd\""
...
public void AddReportingMethod() throws IOException {
    ...
    assertEquals(postResponse.getStatus(), "HTTP/1.1 200 OK", "Status should be OK.");
 ...
 */
	...
	@Test(priority = 13, description = "1. Create a body for adding custom field as {name: \"Name\"}"
 ...
 */
		...
		@Test(priority = 14, description = "1. Create a body for deleting reporting method by ID\n"
...
public void DeleteReportingMethod() throws IOException {
    ...
    assertEquals(deleteResponse.getStatusCode(), 200, "Status code should be 200.");
    assertEquals(deleteResponse.getStatus(), "HTTP/1.1 200 OK", "Status should be OK.");
 ...
 */
		...
		@Test(priority = 15, description = "1. Create a body for adding custom field as {name: {random name}}"
    ...
    String url = "https://opensource-demo.orangehrmlive.com/web/index.php/api/v2/pim/reporting-methods?limit=50&offset=0";
...
public int getFirstCustomFieldId(String cookieValue) {
    String url = "https://opensource-demo.orangehrmlive.com/web/index.php/api/v2/pim/custom-fields?limit=50&offset=0";
    ...
    String url = "https://opensource-demo.orangehrmlive.com/web/index.php/api/v2/pim/custom-fields";
